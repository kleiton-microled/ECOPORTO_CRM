...
namespace WsSimuladorCalculoTabelas.Models
{
    public class Oportunidade
    {
        ...
        public TipoDeProposta TipoDePropostaId { get; set; }

        public string TipoServico { get; set; }

        public TipoServico TipoServicoId { get; set; }
        ...
        public Segmento SegmentoId { get; set; }
        ...
        public TipoValidade TipoValidadeId { get; set; }
        ...
        public int UsuarioIntegracaoId { get; set; }
    }
}